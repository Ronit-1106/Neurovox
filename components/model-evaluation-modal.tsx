...
import { X, CheckCircle, Brain, Database, ShieldAlert, Cpu, BarChart3, Layers } from 'lucide-react';
...
export function ModelEvaluationModal({ isOpen, onClose }: ModelEvaluationModalProps) {
  ...
  const cm = evalMetrics.confusion_matrix || [[0, 0, 0], [0, 0, 0], [0, 0, 0]];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#5D6346]">
                Validated on participant-isolated test partition (zero subject identity overlap)
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-4 rounded-xl bg-white/70 border border-[#DCD6C8] shadow-sm">
              ...
              <div className="text-[11px] text-[#7C8264] mt-0.5">Isolated 15 subjects</div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-[#5D6346]">
              <div className="p-3 rounded-lg bg-[#F5F2EA] border border-[#E0DACB]">
                ...
                <p className="font-mono text-[11px] text-[#4E5B31]">
                  16 Inputs → Dense(128, ReLU) → Dense(64, ReLU) → Dense(32, ReLU) → Dense(3, Softmax)
                </p>
                <div className="mt-2 text-[11px]">
                  <strong>Runtime Engine:</strong> Client-side ONNX Runtime Web / WebAssembly. Runs locally in the browser with 0ms server latency.
                </div>
              </div>
              ...
              <div className="p-3 rounded-lg bg-[#F5F2EA] border border-[#E0DACB]">
                ...
                <p className="text-[11px]">
                  <strong>Total:</strong> 100 participants (1,500 anthropometric frames).<br />
                  <strong>Train (70%):</strong> Subjects 01–70 | <strong>Val (15%):</strong> Subjects 71–85<br />
                  <strong>Test (15%):</strong> Subjects 86–100 (Unseen holdout evaluation).
                </p>
                <div className="mt-1 text-[11px] text-emerald-800 font-medium">
                  ✓ Strict subject-level isolation ensures no identity leakage.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 rounded-xl bg-white/80 border border-[#DCD6C8] space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-[#7C8264] font-medium">
                N = {evalMetrics.total_test_samples || 225} test frames
              </span>
            </div>
